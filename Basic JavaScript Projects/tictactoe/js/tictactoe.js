...
function placeXOrO(squareNumber) {
    ...
    function computersTurn() {
        ...
        while (!success) {
            ...
            // If the random number evaluated returns, the square hasn't been selected yet.
...
function checkWinConditions() {
    ...
    function arrayIncludes(squareA, squareB, squareC) {
        ...
        //true is returned and our else if condition exectures the drawline() function.
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    let x1 = coordX1,
        //This line indcates wehre thte start of a lines y axis is.
        y1 = coordY1,
        ...
        y = y1;
    //This function interactrs with the canvas.
    function animateLineDrawing() {
        ...
        c.lineTo(x, y);
        //This method sets the wdth of our line.
        c.lineWidth = 10;
    ...
    //This line disaallows clicking while the win sound is playing
    disableClick();
